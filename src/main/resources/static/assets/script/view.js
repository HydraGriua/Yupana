...
var navHtml = '<header>' 
	...
	+ '</div>'
	+ '<nav><ul>'
	+	'<a href="records"><li> <i class="fas fa-book"></i> <span>Registros</span></li></a>'
	+	'<a href="clients"><li> <i class="fas fa-address-book"></i> <span>Clientes</span></li></a>'
	+	'<a href="learn_more"><li> <i class="fas fa-graduation-cap"></i> <span>Aprende más </span></li></a>'
	+	'</ul></nav>'
	+'<div class="nav-title">'
